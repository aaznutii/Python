...
На мой взгляд, функция status_input_function() имеет прикладной смысл. Я ее себе сохраню. Принимает в качестве аргумента
текст задания, для его отображения. Сами тексты хаданий хранятся в виде списка в функции main()
    ...
    if status_input_function(list_message[1]) == 0:
        ...
        if status_input_function(list_message[2]) == 0:
            ...
            if revenue > costs:
                ...
                print('Вы в убытках. Вы потеряли: ', revenue - costs, end='\n')
        else:
